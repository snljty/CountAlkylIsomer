...
unsigned int A[MAX_CARBON + 1] = {0};
unsigned int P[MAX_CARBON + 1] = {0}, Q[MAX_CARBON + 1] = {0};
unsigned int C[MAX_CARBON + 1] = {0};

void TryCalc_A_m(unsigned int m);

void Calc_A_m(unsigned int m);

void TryCalc_P_m(unsigned int m);

void Calc_P_m(unsigned int m);

void TryCalc_Q_m(unsigned int m);

void Calc_Q_m(unsigned int m);

void TryCalc_C_m(unsigned int m);

void Calc_C_m(unsigned int m);
